...
\begin{posterbox}[name=definitions,column=0,below=problem]{Basic Concepts}
...
\begin{posterbox}[name=models,column=0,below=definitions]{Models}
...
\begin{posterbox}[name=references,column=0,below=models]{References}
...
\begin{posterbox}[name=acknowledgements,column=0,below=references, above=bottom]{Acknowledgements}
\smaller						% Make the whole text smaller
\vspace{-0.4em}			% Save some space at the beginning
...
\begin{posterbox}[name=density,span=2,column=1,row=0]{Dynamic Networks are Sensitive to Aggregation}
...
\begin{posterbox}
[name=degreeDistribution,span=2,column=1,below=density,above=bottom]{Degree Distribution Radically Changes}
