...
%% Document structure with Eye Cathcher
...
\begin{poster}{
  ...
  borderColor=green,
  headerborder=open,
}{\fbox{\parbox{1cm}{\centering\footnotesize\color{red}Eye Catcher}}}{\fbox{Poster Title}}{\fbox{Poster authors or subtitle}}{\fbox{Logo}}
